package com.concom.soa.infrastructure.persist.app.withdrawTCoinLog;
...
public interface WithdrawTCoinLogDao  extends MybatisRepository<String, WithdrawTCoinLog>{
