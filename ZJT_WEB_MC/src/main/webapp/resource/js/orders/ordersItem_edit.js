...
function buildForm() {
	...
	Ext.lib.Ajax
			.request(
					"post",
					"/mc/OrdersItemServlet.do?type=5&id=" + id,
					{
													...
													new Ext.form.FieldSet(
															{
																...
																items : [
																		...
																		},
																		{
																			width : 180,
																			autoHeight : true,
																			bodyStyle : "min-height:30px;_height:30px;text-align:left;margin-top:0px;",
																			items : [ {
																				xtype : "label",
																				fieldLabel : "套餐类型",
																				id : "itemType",
...
function closeWin() {
	window.parent.Ext.getCmp('center').remove("ordersItem_edit");
};
