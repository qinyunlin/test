...
function getEpInfo(){
	Ext.lib.Ajax.request("post", "/ep/EpAccountServlet?type=20&eid=" + eid,{
...
function saveInfo(){
    ...
    var content="regAddress~"+regAddress+";regCapital~"+regCapital+";regTime~"
                 +regTime+";regNum~"+regNum+";regOffice~"+regOffice+";startTime~"+startTime
                 +";endTime~"+endTime+";businessScope~"+businessScope+";corpn~"+corpn+";enterpriseType~"+enterpriseType;
	query = "ename=" + name + "&eid=" + eid + "&effectDate=" + effectDate +"&content="+content;
...
function closeWin() {
	...
	window.parent.Ext.getCmp('center').remove("credit_purchase_ep_detail");
};
