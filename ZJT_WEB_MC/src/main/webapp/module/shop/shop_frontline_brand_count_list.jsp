...
<script type="text/javascript" src="/resource/js/shop/shop_brand_count_tree.js"></script>
<script type="text/javascript" src="/resource/js/shop/shop_frontline_brand_count_list.js"></script>