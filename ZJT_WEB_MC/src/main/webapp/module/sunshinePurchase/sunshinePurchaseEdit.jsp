...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/ext/UI/css/MultiSelect.css" />
	<script type="text/javascript" src="/ext/UI/Store.js"></script>
	<script type="text/javascript" src="/ext/UI/MultiSelect.js"></script>
	<script type="text/javascript" src="/ext/UI/ItemSelector.js"></script>
	...
	<script type="text/javascript" src="/resource/js/stuff_code_shop.js"></script>
	...
	<script type="text/javascript" src="/resource/js/sunshinePurchase/sunshinePurchaseEdit.js"></script>
</head>
<body>
