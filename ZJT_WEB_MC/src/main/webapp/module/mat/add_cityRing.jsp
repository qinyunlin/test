...
<script type="text/javascript" src="http://c2.zjtcn.com/js/common/jyeeda.js"></script>
...
<script src="http://mc.zjtcn.com/ext/UI/MultiSelect.js"></script>
<script src="http://mc.zjtcn.com/ext/UI/ItemSelector.js"></script>
<script type="text/javascript" src="/resource/js/mat/add_cityRing.js"></script>
<style>
.x-form-element{
  padding-left:0px;
}
