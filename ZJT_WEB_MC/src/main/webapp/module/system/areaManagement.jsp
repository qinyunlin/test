...
<script type="text/javascript" src="/ext/UI/TipSelf.js"></script>
	<script type="text/javascript"
		src="http://c2.zjtcn.com/js/zjt/commonJS/city_site.js"></script>
<script type="text/javascript" src="/resource/js/system/areaManagement.js"></script>
<style>
.x-form-element{
  padding-left:0px;
}
...
<div id="tree" class="x-hidden"></div>
<div id="areaManagement" style="height: 100%"></div>