...
<div id="grid">
	<form method=post
			action="http://ftp.zjtcn.com/file/AutoCreatePic?"
			id="form" target="_blank">
			<input type=hidden id="h_eid" name="eid" value="" />
	</form>
</div>
<script type="text/javascript" src="/resource/js/enterprise/credit_shop_detail.js"></script>
