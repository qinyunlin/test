 ...
 * @ptype roweditor
 */
Ext.ux.grid.RowEditor_Self = Ext.extend(Ext.Panel, {
    floating: true,
    shadow: false,
    layout: 'hbox',
    cls: 'x-small-editor',
    ...
    initComponent: function(){
        Ext.ux.grid.RowEditor_Self.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event beforeedit
    ...
    onRender: function(){
        Ext.ux.grid.RowEditor_Self.superclass.onRender.apply(this, arguments);
    ...
    afterRender: function(){
        Ext.ux.grid.RowEditor_Self.superclass.afterRender.apply(this, arguments);
        this.positionButtons();
    ...
    onShow: function(){
        ...
        Ext.ux.grid.RowEditor_Self.superclass.onShow.apply(this, arguments);
    },

    onHide: function(){
        Ext.ux.grid.RowEditor_Self.superclass.onHide.apply(this, arguments);
        this.stopMonitoring();
...
Ext.preg('roweditor_self', Ext.ux.grid.RowEditor_Self);
